...
def ranodm_forest(data, labels, test_size):
    print("you has been entered in random forest classifier")
...
if __name__ == '__main__':
    ...
    polarity_clf = ranodm_forest(polarity_vecs, np.array(polarity_labels), test_size=0.1)

    # classify emotions dataset
    emotions_clf = ranodm_forest(emotions_vecs, np.array(emotions_labels), test_size=0.1)
